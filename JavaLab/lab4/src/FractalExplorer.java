...
public class FractalExplorer {
    ...
    // JImage для обновления отображения изображения
    private JImageDisplay display;

    // Объекты для разных типов фракталов (будет добавлено позже)
    private FractalGenerator fractal;

    // Объект, определяющий размер текущего диапазона просмотра (То, что показывается в настоящий момент)
    private Rectangle2D.Double range;

    /**
     *  Конструктор, принимающий размер дисплея и сохранящий его,
